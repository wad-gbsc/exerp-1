...
<div id='printContainer'>
    ...
    <table>
        ...
        ?>
        <?php
        foreach($scdiscount as $discount)
        $disc_amount += $discount->disc_amount
        ?>
        <?php
        foreach($beginningamount as $begamount)
        $beg_total_sum += $begamount->net_amount
        ?>
         <?php
        ...
        <tr>
            <td>Date From: &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;{{$date_from}} <br>
                ...
                <hr>
                Beginning: &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;{{number_format($beg_total_sum,2)}}<br>
                Today: &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;{{number_format($net_amount,2)}}<br>
                Ending:&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;{{number_format($net_amount + $beg_total_sum,2)}}<br>
                <hr>
                ...
                Total Qty Sold:&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;{{number_format($total)}}<br>
                Transaction Count:&emsp;&emsp;&emsp;&emsp;&emsp; &emsp;&emsp;{{number_format($totalcost)}}<br>
                <hr>
                No Cash Out
            </td>
        </tr>
    ...
    <table>
		<tr>
			<td >Prepared by : Administrator</td>
		</tr>
	</table>
